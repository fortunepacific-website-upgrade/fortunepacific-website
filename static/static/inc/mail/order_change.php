...
<div style="width:700px; margin:10px auto;">
	...
	<div style="font-family:Arial; padding:15px 0; line-height:150%; min-height:100px; _height:100px; color:#333; font-size:12px;">
        ...
        Your order#<a href="<?=ly200::get_domain();?>/account/orders/view<?=$orders_row['OId'];?>.html" target="_blank" style="color:#1E5494; text-decoration:underline; font-family:Arial; font-size:12px;"><?=$orders_row['OId'];?></a> has changed!<br /><br />
