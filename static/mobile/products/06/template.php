...
?>
    <?php if ($i%2==0){?><div class="home_box clean"><?php }?>
        <div class="small_pro global_border_color <?=$k%2==1 ? 'fr' : 'fl'; ?>">
            <div class="c">
                ...
                <?php if($c['config']['products']['Config']['show_price'] && $c['FunVersion']>=1 && $page_type=='products' && $v['Price_0']>0){?>
                    ...
                    <?php }?>
                <?php }?>
                <a href="<?=$url;?>" class="more global_btn global_border_color"></a>
                <?php if ($page_type=='products'){?>
                    <a href="javascript:;" data="<?=$v['ProId']; ?>" class="inquiry inquiry_btn"></a>
                <?php } ?>
                <div class="clear"></div>
            </div>
        </div>
